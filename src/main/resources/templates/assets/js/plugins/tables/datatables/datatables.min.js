(function (Fa, T, k) {
    var S = function (g) {
        ...
        function S(a) {
            ...
            !a.sEmptyTable && (c && "Nenhuma informação disponível na tabela" === b.sEmptyTable) && F(a, a, "sZeroRecords", "sEmptyTable");
            !a.sLoadingRecords && (c && "Carregando..." === b.sLoadingRecords) && F(a, a, "sZeroRecords", "sLoadingRecords");
        ...
        m.defaults = {
            ...
            oLanguage: {
                ...
                sInfo: "Mostrando resultados _START_ a _END_ de _TOTAL_ resultados totais",
                sInfoEmpty: "Mostrando 0 a 0 de 0 resultados totais",
