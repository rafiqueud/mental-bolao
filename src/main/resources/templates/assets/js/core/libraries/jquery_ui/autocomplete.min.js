...
(function (e) {
    ...
    e.cleanData = function (t) {
        ...
        e.position = {
            ...
            a = e.extend({}, a);
            var p, f, g, v, y, b, _ = e(a.of), x = e.position.getWithinInfo(a.within), k = e.position.getScrollInfo(x),
                T = (a.collision || "flip").split(" "), w = {};
            return b = s(_), _[0].preventDefault && (a.at = "left top"), f = b.width, g = b.height, v = b.offset, y = e.extend({}, v), e.each(["my", "at"], function () {
                ...
                1 === i.length && (i = l.test(i[0]) ? i.concat(["center"]) : u.test(i[0]) ? ["center"].concat(i) : ["center", "center"]), i[0] = l.test(i[0]) ? i[0] : "center", i[1] = u.test(i[1]) ? i[1] : "center", e = d.exec(i[0]), t = d.exec(i[1]), w[this] = [e ? e[0] : 0, t ? t[0] : 0], a[this] = [c.exec(i[0])[0], c.exec(i[1])[0]]
            }), 1 === T.length && (T[1] = T[0]), "right" === a.at[0] ? y.left += f : "center" === a.at[0] && (y.left += f / 2), "bottom" === a.at[1] ? y.top += g : "center" === a.at[1] && (y.top += g / 2), p = t(w.at, f, g), y.left += p[0], y.top += p[1], this.each(function () {
                var s, l, u = e(this), d = u.outerWidth(), c = u.outerHeight(), m = i(this, "marginLeft"),
                    b = i(this, "marginTop"), S = d + m + i(this, "marginRight") + k.width,
                    D = c + b + i(this, "marginBottom") + k.height, N = e.extend({}, y),
                    M = t(w.my, u.outerWidth(), u.outerHeight());
                "right" === a.my[0] ? N.left -= d : "center" === a.my[0] && (N.left -= d / 2), "bottom" === a.my[1] ? N.top -= c : "center" === a.my[1] && (N.top -= c / 2), N.left += M[0], N.top += M[1], n || (N.left = h(N.left), N.top = h(N.top)), s = {
                    ...
                    e.ui.position[T[t]] && e.ui.position[T[t]][i](N, {
                        targetWidth: f,
                        targetHeight: g,
                        elemWidth: d,
                        elemHeight: c,
